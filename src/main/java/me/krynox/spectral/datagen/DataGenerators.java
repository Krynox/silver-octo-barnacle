...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        TagsProvider<Block> blockProvider = generator.addProvider(event.includeServer(), (DataProvider.Factory<ModBlockTags>) (o -> new ModBlockTags(o, event.getLookupProvider() , event.getExistingFileHelper())) );
        generator.addProvider(event.includeServer(), (DataProvider.Factory<ModItemTags>) ( o -> new ModItemTags(o, event.getLookupProvider(), blockProvider, event.getExistingFileHelper())));
